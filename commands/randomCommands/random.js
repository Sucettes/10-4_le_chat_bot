...
const randomTxt = require("../../includes/txtContent/en/contentTxt.json").random;
...
exports.command = {
    data: new SlashCommandBuilder()
        .setName(randomTxt.randomCommandName)
        .setDescription(randomTxt.randomCommandDesc)
        .addStringOption(optType =>
            optType.setName(randomTxt.randomOpt.typeName)
                .setDescription(randomTxt.randomOpt.typeDesc)
                .setRequired(true)
                .addChoices(
        ...
        switch (interaction.options.data[0].value) {
            case "NumberRandom":
                ...
                const randomNumberModal = new ModalBuilder()
                    ...
                    .setTitle(randomTxt.numberRandom.titleModal);

                // create min input
                const minNumberInput = new TextInputBuilder()
                    .setCustomId("minNumberInput")
                    .setLabel(randomTxt.numberRandom.minInputLbl)
                ...
                const maxNumberInput = new TextInputBuilder()
                    ...
                    .setLabel(randomTxt.numberRandom.maxInputLbl)
                    .setStyle(TextInputStyle.Short)
                    .setRequired(true)
                    .setMinLength(1)
                    .setMaxLength(10);
            ...
            case "UserRandom":
                ...
                await interaction.reply({
                    embeds: [
                        await embedMsg.successMsg(randomTxt.userRandom.successTitle, `The member who was drawn is **${memberStr}** !`),
                    ],
                });
                break;
        }
...
exports.onModalRandomNumberSubmit = async (interaction) => {
    ...
    if (!minIsValid && !maxIsValid && !minMaxIsValid) {
        ...
        await interaction.reply({
            embeds: [
                await embedMsg.successMsg(randomTxt.numberRandom.successTitle, desc),
            ],
        });
    }
};
